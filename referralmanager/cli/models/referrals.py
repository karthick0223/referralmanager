...
class ProbioBloodReferral(Base):
    ...
    tid  = Column(String)        
    sign = Column(Integer)        
    countyletter  = Column(String)
    new = Column(String)          
    progression = Column(String)
    follow_up    = Column(String)
    cf_dna1 = Column(String)
    cf_dna2 = Column(String)
    cf_dna3 = Column(String)
    kommentar = Column(String)
    filnamn = Column(String)
    def __init__(self, row_dict):
        ...
        self.tid  = row_dict.get('tid', 'No data')
        self.sign = row_dict.get('sign', 'No data')
        self.countyletter  = row_dict.get('countyletter', 'No data')
        self.new = row_dict.get('new', 'No data')
        self.progression = row_dict.get('progression', 'No data')
        self.follow_up    = row_dict.get('follow_up', 'No data')
        self.cf_dna1 = row_dict.get('CF_DNA1', 'No data')
        self.cf_dna2 = row_dict.get('CF_DNA2', 'No data')
        self.cf_dna3 = row_dict.get('CF_DNA3', 'No data')
...
class PsffBloodReferral(Base):
    ...
    tid  = Column(String)
    sign = Column(Integer)
    blood1 = Column(String)
    blood2 = Column(String)
    blood3 = Column(String)
    blood4 = Column(String)
